<?php
$meta_description = 'Descubre las características de Clinify para ordenar, consultar y centralizar tus estudios médicos de forma sencilla.';
    ...
    <section class="seccion">
        <div class="contenedor caracteristicas-grid">
            ...
            <article class="card caracteristica-card">
                ...
                <h2><?php echo $caracteristicas[0]['titulo']; ?></h2>
            ...
            <article class="card caracteristica-card">
                ...
                <h2><?php echo $caracteristicas[1]['titulo']; ?></h2>
            ...
            <article class="card caracteristica-card">
                ...
                <h2><?php echo $caracteristicas[2]['titulo']; ?></h2>
            ...
            <article class="card caracteristica-card">
                ...
                <h2><?php echo $caracteristicas[3]['titulo']; ?></h2>
